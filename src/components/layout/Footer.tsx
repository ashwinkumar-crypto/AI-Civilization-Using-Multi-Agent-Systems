    ...
    <footer className="relative z-10 border-t border-border/60 bg-surface/40">
      <div className="mx-auto max-w-7xl px-6 py-16">
          ...
          <div className="col-span-2">
            ...
            <div className="mt-6 flex gap-3">
              {[Github, Twitter, Linkedin].map((Icon, i) => (
                <a key={i} href="#" className="flex h-9 w-9 items-center justify-center rounded-lg border border-border/60 text-white/60 transition-colors hover:border-primary/50 hover:text-white">
                  <Icon size={16} />
                </a>
              ))}
            </div>
        ...
        <div className="mt-12 flex flex-col items-center justify-between gap-4 border-t border-border/60 pt-8 text-sm text-white/40 md:flex-row">
          <p>&copy; 2026 {APP_NAME}. Built for National Level Hackathon.</p>
