...
const INITIAL: AppNotification[] = [
  ...
  { id: seededId("NTF", 2), title: "New Alliance Formed", message: "Agent AGT-014 and AGT-027 formed a trade alliance.", type: "success", timestamp: randomPastTimestamp(10), read: false },
